...
describe("format-commit-message", function () {
  ...
  it("works for two {{currentTag}}", function () {
    formatCommitMessage(
      "chore(release): {{currentTag}} \n\n* CHANGELOG: https://github.com/immobiliare/standard-version/blob/v{{currentTag}}/CHANGELOG.md",
      "1.0.0"
    ).should.equal(
      "chore(release): 1.0.0 \n\n* CHANGELOG: https://github.com/immobiliare/standard-version/blob/v1.0.0/CHANGELOG.md"
    );
  });
});
